...
export default function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        if (hasError) {
            ...
            axios
                .post(`http://${process.env.API_HOST || '0.0.0.0'}:8080/sendEmail`, params)
                .then((data) => {
                    setShowModal(true);
                })
    ...
    return (
        <form onSubmit={handleSubmit} id='contact' noValidate>
            <iframe
                ...
                &q=Weidong+Li&center=45.262214, -75.694655&zoom=14`}
                allowFullScreen
            />
            <div className='row'>
                <div className='col-5'>
                ...
                <div className='col-7'>
                    ...
                    <InputField id='email-name' label='Your Name' {...name} error={errors.name} />
                    <InputField
                        id='email-address'
                        label='Your Email'
                        {...email}
    ...
    return (
        <Modal {...props}>
            <Modal.Body>
                <h5>Email Sent!</h5>
                <h6>
                    Thank you so much for taking time to contact me. I'll get back to you as soon as
                    possible.
                </h6>
